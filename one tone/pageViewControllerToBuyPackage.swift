//
//  pageViewControllerToBuyPackage.swift
//  one tone
//
...
class pageViewControllerToBuyPackage: UIPageViewController,UIPageViewControllerDelegate , UIPageViewControllerDataSource {
    ...
    override func viewDidLayoutSubviews() {
        ...
        for view in self.view.subviews{
            if view is UIScrollView{
                ...
                view.backgroundColor = UIColor.clear
                view.frame.origin.y = self.view.frame.height - self.view.frame.height/10
